...
class TravelFeedAdapter(private val mainList: MutableList<String>, ) :
    ...
    inner class ItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {//create an inner class
        ...
        val travelBlurb: TextView= view.findViewById(R.id.travel_blurb)
       // val travelImage: ImageView = view.findViewById(R.id.destination_image)
    ...
    override fun onBindViewHolder(
        ...
        holder.travelBlurb.text = mainList[position]
      //  val travels = imageMainList[position]
       // holder.travelImage.setImageResource(travels)
