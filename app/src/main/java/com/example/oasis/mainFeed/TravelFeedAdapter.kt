...
class TravelFeedAdapter(
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) { //onBindViewHolder called by recyclerView to bind data to Viewholder and fill in layout.

        holder.travelName.text.toString()
